...
import {processChannelJoinRequest} from "./tools.js"
...
const lavaApi = new LavaPayment(process.env.LAVA_SHOP_ID,process.env.LAVA_SECRET_KEY,process.env.LAVA_SHOP_NAME);
