...
import { processChannelJoinRequest, subscriptionMap, createNotificationAdmin } from "./bot/tools.js";
...
bot.on('message', async(msg) => {
  ...
  if(msg.chat.id ==process.env.ADMIN_IDS & msg.reply_to_message.text =='Ответьте на данное сообщение текстом уведомления'){
